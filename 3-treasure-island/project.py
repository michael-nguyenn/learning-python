...
if first_move == "left":
    second_move = input("You \'ve come to a lake. There is an island in the middle of the lake. Type 'wait' to wait "
                        "for a boat. Type 'swim' to swim across.\n").lower()
    if second_move == "wait":
        third_move = input("You arrive at the island unharmed. There is a house with 3 doors. One red, one yellow "
